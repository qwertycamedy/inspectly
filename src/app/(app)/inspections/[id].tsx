      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.heroCard}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={[styles.statValue, inspection.criticalIssuesCount > 0 && styles.critical]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <InfoRow label="Status" value={inspection.status.replace('_', ' ')} />
            <InfoRow label="Priority" value={inspection.priority} />
            <InfoRow label="Scheduled" value={inspection.scheduledAt} />
            <InfoRow label="Deadline" value={inspection.deadlineAt ?? 'No deadline'} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.workflowCard}>
            <WorkflowRow number="1" title="Review object details" description="Confirm location and inspection scope." />
            <WorkflowRow number="2" title="Complete checklist" description="Mark each item as pass, fail, or not applicable." />
            <WorkflowRow number="3" title="Document issues" description="Add comments, priority and photo evidence." />
            <WorkflowRow number="4" title="Submit report" description="Review all findings before sending." />
          </View>
        </View>
